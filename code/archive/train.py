...
def train(checkpoint_path, epochs=200, lr=1E-4, batch=1,
          device='cpu', model_path=None, n=1, dropout=0.1, HYAK=False,
          identity=''):
    """
    ...
    for epoch in range(epochs):
        ...
        for itervar in trange(iterations):
            ...
            with autocast():
                ...
                errorA = 10 * sum([efunc(known_masked_region,
        ...
        print(
            f'Average Train Loss: {losses_train[-1]:.6f}')
...
if __name__ == '__main__':
    ...
    trn(checkpoint_path, epochs=epochs, lr=lr, batch=batch, device=device, n=n,
        params=[None] if fresh else [f"{checkpoint_path}{model_path}"],
